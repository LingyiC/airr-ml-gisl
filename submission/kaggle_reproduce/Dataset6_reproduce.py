...
# --- CONFIGURATION ---
BASE_PATH = Path(args.train_dir) 
TEST_PATH = Path(args.test_dirs)
...
P_VALUE_CUTOFF = 1#0.05 # Relaxed from 1e-5 to 1e-4
...
if len(significant_features) == 0:
    ...
    enrichment_df.to_pickle(OUT_PATH / "enriched_signatures_strict.pkl")
...
enrichment_df = pd.read_pickle(OUT_PATH / "enriched_signatures_strict.pkl")
...
print(f"--- RUNNING PIPELINE FOR DATASET {TRAIN_DIR} ---")
...
seqs_path = os.path.join(OUT_PATH, f"{os.path.basename(TRAIN_DIR)}_important_sequences_fisherexact.tsv")
df_signals = pd.DataFrame(feature_list, columns=['junction_aa', 'v_call', 'j_call'])
df_signals.to_csv(seqs_path, index=False)
print(f"Signals saved to '{seqs_path}'")
...
def main(train_dir: str, test_dirs: List[str], out_dir: str, n_jobs: int, device: str, 
    ...
    #predictions = _generate_predictions(predictor, test_dirs) #cannot handle single test dir (Line 1144), skip anyway
...
try:
    ...
    concatenate_output_files(OUT_PATH)
...
"""
(venv) quack@quacks-MacBook-Pro-326 packcontainer %     python Dataset6_reproduce.py \
        --train_dir /Users/quack/projects/airr/adaptive-immune-profiling-challenge-2025/train_datasets/train_datasets/train_dataset_6 \
        --test_dirs /Users/quack/projects/airr/adaptive-immune-profiling-challenge-2025/test_datasets/test_datasets/test_dataset_6 \
...
Counting sequences...
Positives: 100%|██████████████████████████████| 160/160 [00:05<00:00, 31.24it/s]
Negatives: 100%|██████████████████████████████| 160/160 [00:03<00:00, 42.81it/s]

Scanning for features (Min Pos=3, Max Neg=0, P < 1)...
100%|████████████████████████████| 3346357/3346357 [00:01<00:00, 1833676.52it/s]

========================================
DIAGNOSTIC REPORT
Total Unique Sequences Seen: 3346357
Discarded (Too Rare in Positives): 3284931
Discarded (Too Common in Negatives): 45541
Discarded (Not Significant): 0
KEPT (Significant Signals): 15885
========================================
Top 5 Sequences found:
      pos_count  neg_count       p_value
184          33          0  1.848052e-11
1029         33          0  1.848052e-11
147          27          0  2.249605e-09
89           26          0  4.935699e-09
1151         26          0  4.935699e-09

Saved to 'enriched_signatures_strict.pkl'. You can now run Part 2.
Loaded 15885 features.
Building Training Matrix...
Building Matrix: 100%|████████████████████████| 320/320 [00:05<00:00, 63.41it/s]
Building Validation Matrix...
Building Matrix: 100%|██████████████████████████| 80/80 [00:01<00:00, 64.25it/s]
Training Lasso (L1) Model...

==============================
LASSO RESULTS (Features=15885)
Validation AUC: 0.9894
Validation Acc: 0.8875
Active Features Used: 79
==============================
Avg Prob for Positives: 0.7172
Avg Prob for Negatives: 0.0934
--- RUNNING PIPELINE FOR DATASET /Users/quack/projects/airr/adaptive-immune-profiling-challenge-2025/train_datasets/train_datasets/train_dataset_6 ---
Params: MinPos=3, MaxNeg=0, P=1
Step 1: Loading Metadata...
Training on FULL DATA: 200 Positives, 200 Negatives
Step 2: Counting Sequences (Enrichment)...
Positives: 100%|██████████████████████████████| 200/200 [00:07<00:00, 28.49it/s]
Negatives: 100%|██████████████████████████████| 200/200 [00:04<00:00, 41.71it/s]
Step 3: Calculating Statistics & Selecting Features...
100%|████████████████████████████| 4112564/4112564 [00:01<00:00, 2229852.60it/s]

SELECTED FEATURES: 24630
Signals saved to '/Users/quack/projects/airr/output_reproduce_6/train_dataset_6_important_sequences_fisherexact.tsv'
Step 4: Building Sparse Training Matrix...
100%|█████████████████████████████████████████| 400/400 [00:07<00:00, 53.69it/s]
Step 5: Training Lasso Logistic Regression...
Model Trained. Active Features: 82
Step 6: Processing Test Data...
Found 400 test files.
100%|█████████████████████████████████████████| 400/400 [00:07<00:00, 55.33it/s]

SUCCESS! Predictions saved to '/Users/quack/projects/airr/output_reproduce_6/train_dataset_6_test_predictions.tsv'
                           filename  probability
0  0060a0d196df927b0c41a6e62f061502     0.934598
1  014835b4092ed9f61a8d84a75fc0b4df     0.939578
2  01c6974c6734c6420349465a92308013     0.994422
3  01fcfc48bd89c1814533a7811a3225e4     0.065401
4  022093e62f26e3e600c0b80e6c6efe24     0.214729

================================================================================
Processing Dataset
================================================================================

Fitting model on examples in `/Users/quack/projects/airr/adaptive-immune-profiling-challenge-2025/train_datasets/train_datasets/train_dataset_6`...

[Training] Starting fit on /Users/quack/projects/airr/adaptive-immune-profiling-challenge-2025/train_datasets/train_datasets/train_dataset_6
...
[K-mer Encoding] First pass: collecting k-mer frequencies...
Collecting k-mer frequencies: 100%|███████████| 400/400 [00:48<00:00,  8.28it/s]

[K-mer Encoding] Total unique k-mers: 152070
[K-mer Encoding] Frequent k-mers (count >= 20): 101258
[K-mer Encoding] Memory reduction: 33.4%

[K-mer Encoding] Second pass: encoding features...
Encoding [3, 4]-mers: 100%|███████████████████| 400/400 [00:44<00:00,  8.90it/s]

[K-mer Encoding] Final feature matrix shape: (400, 101258)
Aligned 400 samples with labels
Best C: 0.2 (CV roc_auc: 0.9523)

[Sequence Identification] Identifying top 50000 sequences...
Loading files: 100%|█████████████████████████| 400/400 [00:03<00:00, 112.01it/s]
[Sequence Identification] Scoring 7717545 unique sequences...
Scoring sequences (batched): 100%|████████| 15436/15436 [19:09<00:00, 13.43it/s]
[Sequence Identification] Identified 50000 top sequences ranked by importance score.
[Training] Training complete.
Trained model saved to `/Users/quack/projects/airr/output_reproduce_6/train_dataset_6_model.pkl`.
Important sequences written to `/Users/quack/projects/airr/output_reproduce_6/train_dataset_6_important_sequences.tsv`.

Dataset completed successfully.
Concatenated output written to `/Users/quack/projects/airr/output_reproduce_6/submissions.csv`.
