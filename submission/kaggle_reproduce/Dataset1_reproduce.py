...
def main():
    ...
    K_MERS = [3, 4]  
    SPECIFIC_5_MERS = {"LDPTK", "DPTKS", "PTKSS"} 
...
"""
    python Dataset1_reproduce.py \
        --train_dir /Users/quack/projects/airr/adaptive-immune-profiling-challenge-2025/train_datasets/train_datasets/train_dataset_1 \
        --test_dirs /Users/quack/projects/airr/adaptive-immune-profiling-challenge-2025/test_datasets/test_datasets/test_dataset_1 \
